export const paragraphs = {
  termsOfUse: [
    ...
    {
      title: "4. Privacidade e Segurança dos Dados",
      text: "A privacidade dos usuários é uma prioridade para o CicloÁgil. Garantimos que os dados coletados nunca serão compartilhados com terceiros sem o devido consentimento. Aplicamos medidas rigorosas de segurança para proteger as informações armazenadas, garantindo a integridade e a confidencialidade dos dados pessoais.\nUtilizamos tecnologias avançadas para analisar, organizar e proteger os dados, assegurando um serviço estável e seguro. Nosso compromisso é garantir que a experiência do usuário seja consistente e confiável, respeitando as diretrizes da Lei Geral de Proteção de Dados (Lei 13.709/18)."
    },
    {
    ...
    {
      title: "7. Transparência e Direitos do Usuário",
      text: "O usuário tem o direito de acessar, corrigir ou excluir seus dados pessoais sempre que desejar. Também pode revogar o consentimento para o uso das informações a qualquer momento, além de solicitar esclarecimentos sobre o tratamento dos dados dentro do aplicativo.\nCaso o usuário deseje exercer seus direitos, basta entrar em contato com a equipe de suporte do CicloÁgil para realizar a solicitação."
    },
    {
